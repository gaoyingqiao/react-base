...
// 打印初始状态
console.log('init state: ', __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getState());

// 每次 state 更新的时候，打印日志，subscribe() 返回一个函数来注销监听器
let unsubscribe = __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].subscribe(() => console.log('state update: ', __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getState()));
